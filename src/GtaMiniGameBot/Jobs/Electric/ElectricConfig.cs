...
internal sealed class ElectricConfig
{
    ...
    /// <summary>
    /// Giải xong một minigame thì tự tìm điểm tiếp. Tắt (mặc định) thì dừng lại sau một lượt —
    /// đúng thứ cần cho lượt thử đầu tiên, đọc log xong mới quyết định chạy dài.
    /// </summary>
